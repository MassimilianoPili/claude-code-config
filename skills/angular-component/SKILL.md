...
category: frontend
tags: [angular, components, signals, standalone, templates, lifecycle]
version: 1.0.0
...
- Building new standalone UI components with signal-based inputs and outputs
- Refactoring class-based `@Input`/`@Output` decorators to signal APIs
- Implementing host bindings, content projection, or lifecycle hooks
- Creating accessible interactive components with keyboard navigation
- Using native control flow (`@if`, `@for`, `@switch`) in component templates
