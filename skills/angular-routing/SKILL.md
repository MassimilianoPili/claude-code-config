...
category: frontend
tags: [angular, routing, lazy-loading, guards, resolvers]
version: 1.0.0
...
- Configuring routes, nested routes, and lazy-loaded feature modules
- Implementing functional guards (auth, role-based, unsaved changes)
- Using signal inputs for route parameters and query parameters
- Setting up resolvers to pre-fetch data before route activation
- Programmatic navigation and router event handling
