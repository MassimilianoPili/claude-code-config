...
category: frontend
tags: [angular, http, httpResource, REST, API, interceptors]
version: 1.0.0
...
- Making HTTP requests with signal-based `httpResource()` or `resource()`
- Integrating REST APIs with reactive loading, error, and reload states
- Writing functional HTTP interceptors for auth, logging, or error handling
- Converting Observable-based HTTP patterns to signal-based data fetching
