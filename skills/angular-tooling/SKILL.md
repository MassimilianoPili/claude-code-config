...
category: frontend
tags: [angular, CLI, build, deployment, esbuild, configuration]
version: 1.0.0
...
- Creating new Angular projects and configuring project structure
- Generating components, services, directives, pipes, guards, and interceptors with `ng generate`
- Configuring build options, environments, and production optimizations
- Updating Angular versions and adding libraries with `ng add`
- Analyzing bundle size and managing build cache
