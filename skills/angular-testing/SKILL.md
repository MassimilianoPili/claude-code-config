...
category: frontend
tags: [angular, testing, vitest, jasmine, TestBed, component-harness]
version: 1.0.0
...
- Writing unit tests for components with signals, OnPush change detection, and signal inputs/outputs
- Configuring TestBed with mocked dependencies and providers
- Testing services with HTTP interactions using `HttpTestingController`
- Setting up Vitest as the test runner for Angular v20+ projects
- Testing async operations with `fakeAsync`, `tick`, and `waitForAsync`
