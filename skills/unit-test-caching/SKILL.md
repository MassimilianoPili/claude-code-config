...
// Note: This is a unit test that tests the service logic directly, not the caching behavior.
// @Cacheable annotations are NOT active without a Spring proxy.
// For testing actual caching behavior, use @SpringBootTest with @EnableCaching.
